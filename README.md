...
#### [Adaptive Questioning](./prompts/adaptive-questioning/prompt.md)
...
#### [Visual Hierarchy with Emoji](./prompts/visual-hierarchy-with-emoji/prompt.md)
...
#### [Fallback Options](./prompts/fallback-options/prompt.md)
...
Mandatory Function Call Announcements

- **Model**: Not specified
- **Updated**: 8/18/2025

#### [Never Skip Functions](./prompts/never-skip-functions/prompt.md)
...
#### [Best Practices](./prompts/best-practices/prompt.md)
...
#### [Citation Rules](./prompts/citation-rules/prompt.md)
...
#### [Multiple Citations](./prompts/multiple-citations/prompt.md)
...
#### [Pacing Strategies](./prompts/pacing-strategies/prompt.md)
